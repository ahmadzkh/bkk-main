        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav medium text-center mx-auto">
                    ...
                    <li class="nav-item ms-lg-5">
                        <a class="nav-link {{ ($active === 'partner') ? 'active' : ''}}" href="{{route('bkk.mitra')}}">Partners</a>
                    </li>
                    <li class="nav-item ms-lg-5">
                ...
                <ul class="navbar-nav ms-auto mt-3 text-white">
                    <div class="dropdown">
                        <div class="row user" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="col text-primary" style="width: 250px;">
                            ...
                            <div class="col text-primary dropdown-toggle"></div>
                        </div>
                    ...
                    <a href="#" class="text-decoration-none a-info">
                        ...
                        <div class="row p-3 text-black-50">
                            ...
                            <div class="col d-flex justify-content-end">
                                <div class="small">
                                    <i class="bi bi-calendar me-1"></i> {{ \Carbon\Carbon::parse($new->created_at)->diffForHumans() }}
                                </div>
                            </div>
                        </div>
                    </div>
