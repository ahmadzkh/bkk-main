        ...
        <div class="content-outer-wrapper mx-auto">
            <div class="container py-3 content-wrapper">
                ...
                <div class="title-back">
                    <a href="{{ URL::previous() }}" class="d-flex align-items-center text-decoration-none text-white"><i class='bx bx-left-arrow-alt'></i>Back</a>
                </div>
                    ...
                    <div class="data me-4 bg-white rounded-15 px-4 py-3">
                        ...
                        <form action="{{route('admin.alumni.store')}}" method="POST" class="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-15 @error('nama') is-invalid @enderror" id="nama" placeholder="Nama Lengkap Alumni" onkeyup="updateNama(this.value)" name="nama" value="{{old('nama')}}">
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control rounded-15 @error('nis') is-invalid @enderror" id="nis" onkeyup="updateNis(this.value)" placeholder="NIS Alumni" maxlength="12" name="nis" value="{{old('nis')}}">
                                @error('nis')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control rounded-15 @error('nisn') is-invalid @enderror" id="nisn"  onkeyup="updateNisn(this.value)" placeholder="NISN Alumni" maxlength="12" name="nisn" value="{{old('nisn')}}">
                                @error('nisn')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select rounded-15 @error('jurusan') is-invalid @enderror" onchange="updateJur(this.value)" name="jurusan">
                                    ...
                                    <option value="{{$jurusan->id_jurusan}}" @if (old('jurusan') === $jurusan->id_jurusan)
                                        {{'selected'}}
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select rounded-15 @error('angkatan') is-invalid @enderror" onchange="updateAng(this.value)" name="angkatan">
                                    <option hidden>Tahun Lulus</option>
                                    @foreach ($angkatan as $ang)
                                    <option value="{{$ang->id_angkatan}}" @if (old('angkatan') === $ang->id_angkatan)
                                        {{'selected'}}
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-15" id="username_input" placeholder="NIS Alumni"
                                    name="username" readonly>
                                <input type="text" class="form-control rounded-15" id="username_input" placeholder="Username"
                                    name="username" hidden>
                            </div>
                            <div class="mb-3">
                                <label for="password" class="form-label">Password</label>
                                <input type="password" class="form-control rounded-15" id="password_input" placeholder="NIS Alumni"
                                    name="password" disabled>
                                <input type="text" class="form-control rounded-15" id="password_input" placeholder="Password"
                                    name="password" hidden>
                            </div>
                            <div class="mb-3">
                                <label for="level" class="form-label">Level</label>
                                <input type="text" class="form-control rounded-15" id="level" placeholder="Alumni"
                                    name="level" disabled>
                                <input type="text" class="form-control rounded-15" id="level" placeholder="level"
                                    name="level" value="LVL00002" hidden>
                            </div>
...
@section('script')
    ...
    <script>
        ...
        function updateNis(data) {
            ...
            document.getElementById("username_input").value = data;
