                    ...
                    <div class="search py-3">
                        <form action="" method="GET" class="position-relative">
                            ...
                            <div class="input-group mb-3 px-5">
                                <input type="text" class="form-control rounded-20 shadow" placeholder="Search News" name="keyword">
                            </div>
                        </form>
                    </div>
                                ...
                                <div class="news p-2">
                                    <div class="shadow rounded-20 bg-white">
                                        ...
                                        <div class="content p-3">
                                            <a href="{{ route('admin.news.detail', $new->id_informasi) }}" class="text-decoration-none text-link-black">
                                                <p class="fw-bold">{{ $new->title }}</p>
                                            </a>
                                            <div class="d-flex justify-content-between">
                                                <p class="mb-1">{{ $new->admin->nama }}</p>
